...
public class Lv_Adapter_Complete extends BaseAdapter {

    private Context mContext;
    private ArrayList<ListItem_Complete> arrayList;

    public Lv_Adapter_Complete(Context context, ArrayList<ListItem_Complete> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            ((TextView)view.findViewById(R.id.tv_point3_talentcondition_listview)).setText("재능공유 완료 시 ");
            ...
            if(arrayList.get(position).isIsmentor())
            {
                ...
                nameTxt = arrayList.get(position).getName() + " 멘토와 재능공유를" + " 완료합니다.";
                dateTxt = arrayList.get(position).getDate() + "에 진행";
                holder.btn_progress.setText("완료");
            ...
            else
            {
                ...
                nameTxt = arrayList.get(position).getName() + " 멘티와 재능공유를" + " 완료합니다.";
                dateTxt = arrayList.get(position).getDate() + "에 진행";
